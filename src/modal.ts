const gameModal = function (this: any, game: any) {
    var _this = this;
     ...
     */
    this.hideModal = function (type: string | number) {
    ...
    return {
        createModal: function (options: {
            ...
            if (includeBackground === true) {
                ...
                if (modalCloseOnInput === true) {
                    ...
                    innerModal.on('pointerdown', (e: any) => {
                        console.log(e);
            ...
            for (var i = 0; i < itemsArr.length; i += 1) {
                ...
                if (itemType === 'text' || itemType === 'bitmapText') {
                    if (itemType === 'text') {
                        ...
                        modalLabel.y =
                            game.game.config.height / 2 - modalLabel.height / 2 + offsetY;
                    } else {
                        modalLabel = game.add.bitmapText(
                            0,
                            0,
                            itemFontfamily,
                            String(content),
        ...
        getModalItem: function (type: any, index: any) {
            return game.modals.getChildAt(index);
        },
        showModal: function (type: string | number) {
            console.log(type, game.modals[type]);
            game.modals[type].visible = true;
            // you can add animation here
        },
        hideModal: function (type: string | number) {
            game.modals[type].visible = false;
            // you can add animation here
        },
        destroyModal: function (type: string | number) {
